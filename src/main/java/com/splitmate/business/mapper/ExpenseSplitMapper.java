...
public interface ExpenseSplitMapper
{
    ...
    ExpenseSplitInfoDTO mapEntityToDTO(ExpenseSplitEntity entity);
    ...
    @Mapping(target = "paymentStatus", expression = "java(PaymentStatus.valueOf(dto.getPaymentStatus()))")
    void mapUpdateDTOToEntity(UpdateExpenseSplitDTO dto, @MappingTarget ExpenseSplitEntity entity);
    ...
    ExpenseSplitEntity mapToExpenseSplitEntity(ExpenseEntity expenseEntity, UserEntity userEntity, double splitAmount, PaymentStatus paymentStatus);
}
